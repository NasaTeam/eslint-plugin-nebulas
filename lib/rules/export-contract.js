...
module.exports = {
  meta: {
    ...
    messages: {
      prototypeOrClass: 'A Contract must be a Prototype Object or Class',
      ...
      MemberExpression(node) {
        ...
        if (node.property.name === 'prototype' && node.parent.type === 'AssignmentExpression') {
          ...
          if (assignmentExpressionNode.right.type === 'Identifier') {
            ...
            if (defNode.node.type === 'VariableDeclarator' && defNode.init && defNode.init.type !== 'ObjectExpression') {
              return
            }
        ...
        if (node.object.name === 'module' && node.property.name === 'exports') {
          ...
          if (
            ...
            if (defNode.type !== 'ClassName' && defNode.type !== 'FunctionName') {
